            ...
            function register() {
                ...
                if (users.find(x => x.email === user.email)) {
                    ...
                    setTimeout(() => {
                        alertService.info(`
                         ...
                         <div><strong>NOTE:</strong> The backend displayed this "email" so you can test without an api. A real backend sends a real email.</div>
                        `, { autoClose: false });
                    }, 1000);
                ...
                setTimeout(() => {
                    ...
                    alertService.info(`
                        ...
                        <div><strong>NOTE:</strong> The backend displayed this "email" so you can test without an api. A real backend sends an email.</div>
                    `, { autoClose: false });
                }, 1000);
            ...
            function forgotPassword() {
                ...
                setTimeout(() => {
                    ...
                    alertService.info(`
                        ...
                        <p>Please click the below link to reset your password, the link will be valid for _ day(s):</p>
